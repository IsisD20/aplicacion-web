...
<main class="container p-4">
  <div class="row">
    <div class="col-md-4">
      ...
      <?php session_unset(); } ?> <!--limpia los datos que se tienen en sesion->

      <!-agregar tarea -->
      <div class="card card-body">
        <form action="save_task.php" method="POST"> <!--- nos dice que mandara los datos a save_task.php -->
    ...
    <div class="col-md-8">
      <table class="table table-bordered"> <!--clase de boostrap-->
        <thead>
          <tr>
            <th>Titulo</th>
            <th>Descripción</th>
        ...
        <tbody>
          <?php
          $query = "SELECT * FROM task"; //consulta de las tareas de la tabla tareas en mysql
